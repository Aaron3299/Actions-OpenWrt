...
svn export https://github.com/kenzok8/openwrt-packages/trunk/alist package/diy/alist
svn export https://github.com/kenzok8/openwrt-packages/trunk/luci-app-alist package/diy/luci-app-alist
